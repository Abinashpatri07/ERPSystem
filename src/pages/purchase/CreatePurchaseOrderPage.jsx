...
const CreatePurchaseOrderPage = () => {
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden bg-white">
      ...
      {/* ── Content ── */}
      <div className="flex-1 overflow-hidden bg-[#f4f7f9] p-1.5 flex flex-col gap-1.5">
        ...
        <div className="bg-white px-6 py-2 md:px-8 md:py-3 flex items-center justify-between border border-gray-200 rounded-2xl shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-0">
            ...
            <div className="flex flex-col items-center flex-shrink-0 w-16 md:w-20">
              ...
              <span className="text-[10px] md:text-[11px] font-bold text-gray-900 text-center leading-tight">Purchase order</span>
            </div>
          ...
          {rows.map(row => (
            <div key={row.id} className="grid gap-2 items-center py-1.5 border-b border-gray-100"
              ...
              <div className="flex items-center gap-2">
                ...
                <input type="text" className="flex-1 border border-gray-200 rounded-md px-3 py-2 text-[12px] focus:outline-none focus:border-blue-500" />
              </div>

              {/* Account */}
              <div className="relative">
                <select className="w-full border border-gray-200 rounded-md px-2 py-2 text-[12px] focus:outline-none focus:border-blue-500 appearance-none bg-white">
                  <option></option>
                </select>
              ...
              <div className="relative">
                ...
                <input type="number" className="w-full border border-gray-200 rounded-md pl-6 pr-2 py-2 text-[12px] focus:outline-none focus:border-blue-500" />
              </div>

              {/* Amount */}
              <div className="relative">
                <span className="absolute left-2.5 top-2 text-gray-400 text-[12px]">₹</span>
                <input type="number" className="w-full border border-gray-200 rounded-md pl-6 pr-2 py-2 text-[12px] focus:outline-none focus:border-blue-500 bg-gray-50" readOnly />
              </div>
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" defaultValue="20,00,00" className="w-full border border-gray-200 rounded-md pl-7 pr-12 py-2 text-[13px] focus:outline-none focus:border-blue-500" />
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3 top-2 text-gray-500 text-[13px]">₹</span>
                <input type="text" defaultValue="50,00,00" className="w-full border border-gray-200 rounded-md pl-7 pr-12 py-2 text-[13px] focus:outline-none focus:border-blue-500" />
                <span className="absolute right-3 top-2 text-gray-400 text-[13px]">INR</span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6 shrink-0 mb-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-6 py-5">
            ...
            <textarea
              rows={5}
              className="w-full border border-gray-200 rounded-md px-3 py-2.5 text-[13px] text-gray-600 focus:outline-none focus:border-blue-500 placeholder-gray-300"
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200 px-8 py-3 flex justify-end items-center gap-3">
        <button className="flex items-center gap-2 px-6 py-2 rounded-full bg-gray-100 text-[13px] font-semibold text-gray-600 hover:bg-gray-200 transition-colors">
          <Bookmark className="w-4 h-4" /> Save Draft
        </button>
        <button
          onClick={() => navigate('/purchase')}
          className="px-6 py-2 border border-gray-200 rounded-full text-[13px] font-semibold text-gray-600 hover:bg-gray-50 transition-colors"
        >
          Cancel
        </button>
        <button
          onClick={() => navigate('/purchase')}
          className="px-8 py-2 bg-gradient-to-r from-[#ff7a59] via-[#d54a88] to-[#402de8] text-white rounded-full text-[13px] font-bold hover:opacity-90 transition-colors shadow-sm"
        >
          Save
        </button>
      </div>
