      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 flex flex-col">
        ...
        <div className="flex-1 flex space-x-4 overflow-hidden min-h-0">
            ...
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-3">
              ...
              <div className="border border-gray-100 bg-white rounded-xl p-4 shadow-sm cursor-pointer hover:border-gray-200 transition-colors">
                <div className="flex justify-between items-center mb-1.5">
                  <span className="text-[13px] font-bold text-gray-900">SO-00001</span>
          ...
          <div className="flex-1 flex flex-col overflow-hidden min-h-0">
            ...
            {/* Detail Header */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 py-2.5 flex items-center justify-between flex-shrink-0 mb-3">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pb-4">
              ...
              {/* Address Details */}
              <div className="bg-white border border-gray-100 rounded-xl shadow-sm mb-3">
