          ...
          <form id="customer-form" className="max-w-6xl" onSubmit={handleSubmit}>
                ...
                <div className="flex items-start min-w-0">
                  ...
                  <div className="flex-1 flex items-center space-x-3 min-w-0">
                    <div className="relative w-12 shrink-0">
                      <select className="w-full border border-gray-200 rounded-md px-1 py-2 text-[13px] text-gray-600 focus:outline-none focus:border-blue-500 appearance-none bg-white shadow-sm text-center">
                        <option></option>
                        <option>Mr.</option>
                        <option>Ms.</option>
                      </select>
            ...
            <div className="pt-8">
              ...
              <div className="py-6">
                ...
                {activeTab !== 'Other Details' && activeTab !== 'Address' && activeTab !== 'Contact Person' && (
